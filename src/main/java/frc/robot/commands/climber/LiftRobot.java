...
public class LiftRobot extends CommandBase {
    ...
    public LiftRobot(ClimberSubsystem subsystem) {
        m_climber = subsystem;
    ...
    public void initialize() {
        ...
        m_climber.setClimberState(ClimberState.CLIMBING);
    ...
    public void end(boolean interrupted) {
        ...
        if (interrupted) {
            ...
            // We just finished lifting the robot up here.
            m_climber.setClimberState(ClimberState.CLIMBED);
        }       
    }
